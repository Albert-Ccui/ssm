      		...
      		<div class="container">
				...
				<div id="navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav navbar-right">			            
						<li><a href="###" onclick="showAtRight('${proPath}/selectcourse/getAll.action')"><i class="fa fa-list-alt"></i> 成绩评分</a></li>
					</ul>
...
<!-- 右侧内容展示==================================================   -->   		
 				<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
					<h1 class="page-header"><small>&nbsp;&nbsp;&nbsp;欢迎你,教师： ${user.getuser_name() }</small></h1>
